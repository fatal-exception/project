...
//        google.maps.event.addDomListener(window, "load", initMap);
   ...
   (function( _samtla, undefined ) {
        ...
        _samtla.Tick  = function(){
            ...
            if(_samtla.imgwidget && _samtla.imgwidget.updateRequired == true){// && this.img_layer.canvas != undefined){
...
//            script.src = ("{% static '" + url + "' %}").toString()//"{% static '" + url + "' %}"; 
        ...
        //        drawDocument(_samtla.settings['document_data'], 'doc');
        ...
        _samtla.load_settings = function(objName){
            if(localStorage && localStorage[objName]){
              ...
              //  console.log("load settings", objName, attr, val);
   ...
   // _samtla.Tick();          
    ...
    function replaceAll(str, find, replacewith) {
     //   console.log(find, replacewith, replacewith, str.replace('/'+find+'/g', replacewith))//);)
